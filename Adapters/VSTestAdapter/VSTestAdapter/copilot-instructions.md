...
Always follow Test-Driven Development when creating or modifying code in this repository.
...
**Always create an explicit plan before making any code changes.** This ensures clear tracking of test vs implementation modifications.
